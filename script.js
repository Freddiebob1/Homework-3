...
form.addEventListener('submit', e => {
    ...
    const includeUppercase = includeUppercaseElemnt.checked
    const includeNumbers = includeNumbersElemnt.checked
    const includeSymbols = includeSymbolsElemnt.checked  
...
function generatePassword(characterAmount, includeUppercase, includeNumbers, includeSymbols) 
{
    ...
    for (let i = 0; i < characterAmount, i++)
    {
        ...
        passwordCharacter.push(String.fromCharCode(charCodes)) 
